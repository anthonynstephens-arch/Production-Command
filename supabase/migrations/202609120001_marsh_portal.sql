create table if not exists public.marsh_inventory (
  ...
  item_key text not null check (item_key in ('blank_mats', 'shipping_boxes', 'ink', 'packing_tape', 'packing_tape_coverage', 'packing_tape_usage', 'thank_you_cards', 'poly_bags')),
